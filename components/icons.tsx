/**
 * Shared icon registry. Content data references an icon by key (see lib/content),
 * and components render it with <Icon name="..." className="..." />. This keeps
 * the SVG markup in the presentation layer and out of the content.
 */

// Each entry is the icon's <path> "d" values. Multi-path icons list more than one.
const PATHS = {
